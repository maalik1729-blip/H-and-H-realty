# Individual Stage Commands — Land Connect Redesign
...
Modify actual src/ files as specified (site-chrome.tsx, listing-card.tsx, global-enquiry.tsx, listings.index.tsx, listings.$id.tsx).
...
Use build validation command (npm run build) to ensure zero typescript compile breaks.
